...
public class MainApp extends Application {
    ...
    public void start(Stage stage) {
        try {
            ...
            auditoriaRepository = new AuditoriaRepository(database);
    ...
    private Node criarMenu() {
        ...
        Button definicoes = null;
        if (usuarioAtual.isGerente()) {
            definicoes = criarBotaoMenu(
                "🔒",
                "Definições",
                this::criarDefinicoes
            );
        }
        ...
        if (definicoes != null) {
            menu.getChildren().add(definicoes);
        }
        ...
        btnAtualizar.setOnAction(e -> {
            ...
            try {
                ...
                registrarLogSeguro(
                    "ALTERAR_CLIENTE",
                    "Clientes",
                    "Alterou o e-mail do cliente com CIL " + cliente.cil() + "."
                );
        ...
        btnEliminar.setOnAction(e -> {
            ...
            try {
                ...
                registrarLogSeguro(
                    "ELIMINAR_CLIENTE",
                    "Clientes",
                    "Eliminou o cliente " + cliente.nome() + " (CIL: " + cliente.cil() + ")."
                );
        ...
        btnGuardar.setOnAction(e -> {
            ...
            try {
                ...
                registrarLogSeguro(
                    "ALTERAR_CORPO_EMAIL",
                    "Configuração",
                    "Alterou o corpo padrão do e-mail."
                );
    ...
    private Node criarGestaoUtilizadores() {
        ...
        Label descricao = new Label(
            "Crie e altere utilizadores, palavras-passe e níveis de acesso."
        );
        ...
        TextField txtPasswordVisivel = new TextField();
        txtPasswordVisivel.setPromptText("Palavra-passe");
        txtPasswordVisivel.setVisible(false);
        txtPasswordVisivel.setManaged(false);

        txtPassword.textProperty().bindBidirectional(
            txtPasswordVisivel.textProperty()
        );

        PasswordField txtConfirmar = new PasswordField();
        txtConfirmar.setPromptText("Confirmar palavra-passe");

        TextField txtConfirmarVisivel = new TextField();
        txtConfirmarVisivel.setPromptText("Confirmar palavra-passe");
        txtConfirmarVisivel.setVisible(false);
        txtConfirmarVisivel.setManaged(false);

        txtConfirmar.textProperty().bindBidirectional(
            txtConfirmarVisivel.textProperty()
        );

        StackPane painelPassword = new StackPane(
            txtPassword,
            txtPasswordVisivel
        );

        StackPane painelConfirmar = new StackPane(
            txtConfirmar,
            txtConfirmarVisivel
        );
        ...
        CheckBox chkMostrarPassword =
            new CheckBox("Mostrar palavras-passe");
        ...
        chkMostrarPassword.setOnAction(event -> {
            boolean mostrar =
                chkMostrarPassword.isSelected();

            txtPassword.setVisible(!mostrar);
            txtPassword.setManaged(!mostrar);

            txtPasswordVisivel.setVisible(mostrar);
            txtPasswordVisivel.setManaged(mostrar);

            txtConfirmar.setVisible(!mostrar);
            txtConfirmar.setManaged(!mostrar);

            txtConfirmarVisivel.setVisible(mostrar);
            txtConfirmarVisivel.setManaged(mostrar);
        ...
        btnGuardar.setOnAction(event -> {
            ...
            try {
                ...
                registrarLogSeguro(
                    ...
                    "Criou o utilizador " + username + " com nível " + nivel + "."
                );
        ...
        btnAlterar.setOnAction(event -> {
            ...
            try {
                ...
                boolean retirarNivelAdmin =
                    selecionado.isAdmin()
                    && !"admin".equalsIgnoreCase(nivel);

                if (retirarNivelAdmin
                        && usuarioRepository
                            .contarAdministradores() <= 1) {

                    mostrarAviso(
                        "Não é possível alterar o nível " +
                ...
                registrarLogSeguro(
                    "ALTERAR_UTILIZADOR",
                    "Gestão de Utilizadores",
                    "Alterou o utilizador ID " + selecionado.id() + " para " + username + "."
                );
                ...
                if (selecionado.id()
                    ...
                    stage.setUserData(usuarioAtual);
                    root.setLeft(criarMenu());
                }
        ...
        btnEliminar.setOnAction(event -> {
            ...
            try {
                ...
                mostrarErro(
                    "Erro ao verificar administradores",
                    e
                );
                return;
            }
            ...
            try {
                ...
                registrarLogSeguro(
                    "ELIMINAR_UTILIZADOR",
                    "Gestão de Utilizadores",
                    "Eliminou o utilizador " + selecionado.username() + "."
                );
    ...
    private boolean validarDadosUtilizador(
            String username,
            String password,
            String confirmar,
            String nivel
    ...
    private void sairAplicacao() {
        ...
        if (confirmacao.showAndWait().orElse(ButtonType.NO)
            ...
            registrarLogSeguro(
                "SAIR_APLICACAO",
                "Sistema",
                "Fechou completamente a aplicação."
            );
    ...
    private void registrarLogSeguro(
            String operacao,
            String modulo,
            String descricao
    ) {
        if (auditoriaRepository == null || usuarioAtual == null) {
            return;
        }
        ...
        try {
            ...
            System.err.println(
                "Não foi possível registar o log: " + e.getMessage()
            );
        }
    }
