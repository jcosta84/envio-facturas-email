...
- Exportação para PDF;
- Estrutura própria `ListaLigada<T>`.
...
A classe `ListaLigada<T>` foi implementada manualmente para armazenar temporariamente os resultados do processamento dos envios.
